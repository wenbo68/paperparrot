...
1. do not let your frontend call python apis directly
2. your frontend should only call trpc procedures, which validates the request and call your python apis
    ...
    - 3 benefits:
        1. your python apis don't need to validate, and you don't want your python backend to validate requests because...
            - nextjs has the user's Authjs cookies; python doesnt
...
- langgraph is built on top of langchain but adds 3 main concepts:
    ...
    3. checkpointer: autosaves state and history to db
